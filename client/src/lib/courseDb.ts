...
export interface StoredCourse { id: string; course: Course; sourceFileName: string; sourcePageCount: number; createdAt: number; completedLessonIds: string[]; lastOpenedAt: number; modelUsed?: string; fallbackOccurred?: boolean; }
...
export const defaultSettings: LocalProviderSettings = { provider: "openai", model: "auto", language: "tr", rememberKey: false };
